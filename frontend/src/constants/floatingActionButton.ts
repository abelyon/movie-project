export const floatingActionButtonBaseClass =
  "flex items-center justify-center rounded-4xl border-t border-neutral-600 bg-neutral-800/80 p-4 text-neutral-300 backdrop-blur-md transition-colors hover:text-white";
