...
export const mediaBadgeHeroScoreClass =
  "font-space-grotesk text-xl font-medium text-neutral-100";
...
export const mediaBadgePosterScoreClass =
  "font-space-grotesk text-base font-medium text-neutral-100";

export const mediaBadgePosterOverlayPadding = "p-4";
